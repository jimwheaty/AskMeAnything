...
let AnswerService = class AnswerService {
    constructor(authClient, answerModel, questionModel) {
...
AnswerService = __decorate([
    ...
    __param(1, sequelize_1.InjectModel(answer_model_1.Answer)),
    __param(2, sequelize_1.InjectModel(question_model_1.Question)),
